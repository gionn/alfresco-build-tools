...
```yaml
    - uses: Alfresco/alfresco-build-tools/.github/actions/automate-propagation@v10.4.1
      with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/calculate-next-internal-version@v10.4.1
        with:
          next-version: 1.2.3
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/configure-git-author@v10.4.1
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/dependabot-missing-actions-check@v10.4.1
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/dispatch-resume-workflow@v10.4.1
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/docker-build-image@v10.4.1
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/docker-dump-containers-logs@v10.4.1
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/docker-scan-image-dirs@v10.4.1
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/enforce-pr-conventions@v10.4.1
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/env-load-from-yaml@v10.4.1
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/free-hosted-runner-disk-space@v10.4.1
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/get-branch-name@v10.4.1
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/get-build-info@v10.4.1
```
...
jobs:
  cleanup:
    ...
    steps:
      - uses: Alfresco/alfresco-build-tools/.github/actions/gh-cache-cleanup-on-merge@v10.4.1
        with:
...
```yaml
    - uses: Alfresco/alfresco-build-tools/.github/actions/git-check-existing-tag@v10.4.1
      with:
        tag: 1.0.0
```
...
```yaml
      ...
      - uses: actions/checkout@v3
        with:
          fetch-depth: 0
      - uses: Alfresco/alfresco-build-tools/.github/actions/get-commit-message@v10.4.1
```
...
```yaml
    - uses: Alfresco/alfresco-build-tools/.github/actions/git-commit-changes@v10.4.1
      with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/git-latest-tag@v10.4.1
        with:
          pattern: 1.0.0-alpha*
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/github-check-upcoming-runs@v10.4.1
        with:
  ...
  job:
    ...
    steps:
      - name: Create Deployment
        ...
        uses: Alfresco/alfresco-build-tools/.github/actions/github-deployment-create@v10.4.1
        with:
      ...
      - name: Update Deployment State to failure
        ...
        uses: Alfresco/alfresco-build-tools/.github/actions/github-deployment-status-update@v10.4.1
        with:
          github-token: ${{ secrets.GITHUB_TOKEN }}
...
```yaml
    ...
    steps:
      - uses: Alfresco/alfresco-build-tools/.github/actions/github-deployments-delete@v10.4.1
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/download-file@v10.4.1
        with:
          github-token: ${{ secrets.BOT_GITHUB_TOKEN }}
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/github-https-auth@v10.4.1
        with:
          username: ${{ vars.BOT_GITHUB_USERNAME }}
...
```yaml
      - uses: actions/checkout@v3
        with:
          fetch-depth: 0
      - uses: Alfresco/alfresco-build-tools/.github/actions/github-list-changes@v10.4.1
        with:
  ...
  check-dependabot:
    ...
    steps:
      - name: dependabot check
        id: dependabot
        uses: Alfresco/alfresco-build-tools/.github/actions/github-pr-check-metadata@v10.4.1
        with:
...
jobs:
  check:
    runs-on: ubuntu-latest
    steps:
      - uses: Alfresco/alfresco-build-tools/.github/actions/github-require-secrets@v10.4.1
        with:
...
jobs:
  check:
    runs-on: ubuntu-latest
    steps:
      - uses: Alfresco/alfresco-build-tools/.github/actions/github-trigger-approved-pr@v10.4.1
        with:
          github-token: ${{ secrets.BOT_GITHUB_TOKEN }}
...
jobs:
  check:
    runs-on: ubuntu-latest
    steps:
      - uses: Alfresco/alfresco-build-tools/.github/actions/github-trigger-labeled-pr@v10.4.1
        with:
          github-token: ${{ secrets.BOT_GITHUB_TOKEN }}
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/helm-build-chart@v10.4.1
        with:
...
```yaml
      - name: Execute dry run
        uses: Alfresco/alfresco-build-tools/.github/actions/helm-integration-tests@v10.4.1
        with:
...
```yaml
    - uses: Alfresco/alfresco-build-tools/.github/actions/helm-package-chart@v10.4.1
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/helm-parse-next-release@v10.4.1
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/helm-publish-chart@v10.4.1
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/helm-release-and-publish@v10.4.1
        with:
          version: 1.0.0
          chart-dir: charts/common
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/helm-template-yamllint@v10.4.1
        with:
...
```yaml
     - uses: >-
         Alfresco/alfresco-build-tools/.github/actions/helm-plugin@v10.4.1
       with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/helm-update-chart-version@v10.4.1
        with:
          new-version: 1.0.0
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/install-galaxy-deps@v10.4.1
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/install-ubuntu-default-tools@v10.4.1
        with:
...
```yaml
      - name: Promote version
        uses: Alfresco/alfresco-build-tools/.github/actions/jx-updatebot-pr@v10.4.1
        with:
...
```yaml
    - name: Upload pods logs
      if: always()
      uses: >-
        Alfresco/alfresco-build-tools/.github/actions/kubectl-keep-nslogs@v10.4.1
      with:
        namespace: mynsapp
        log_retention: 7
...
```yaml
    - name: Wait for pods to be ready
      uses: Alfresco/alfresco-build-tools/.github/actions/kubectl-wait@v10.4.1
      # with:
        # wait-timeout: 10m
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/load-release-descriptor@v10.4.1
        id: load-descriptor
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/maven-configure@v10.4.1
        with:
          java-version: '21'
          maven-version: '3.8.8'
```
...
```yaml
- uses: Alfresco/alfresco-build-tools/.github/actions/maven-dependency-scan@v10.4.1
  with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/maven-build@v10.4.1
        with:
          java-version: '21'
...
```yaml
    ...
    steps:
      - uses: Alfresco/alfresco-build-tools/.github/actions/maven-build-and-tag@v10.4.1
        id: build-and-tag
        with:
...
```yaml
      - name: Deploy to Nexus
        uses: Alfresco/alfresco-build-tools/.github/actions/maven-deploy-file@v10.4.1
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/maven-release@v10.4.1
        with:
...
```yaml
    - uses: Alfresco/alfresco-build-tools/.github/actions/maven-update-pom-version@v10.4.1
      with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/md-toc@v10.4.1
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/nexus-move-artifacts@v10.4.1
        with:
...
```yaml
      - name: Build Nuxeo image
        uses: Alfresco/alfresco-build-tools/.github/actions/nuxeo/nuxeo-docker-build@v10.4.1
        with:
          base-image-tag: 2023
...
jobs:
  pre-commit:
    ...
    steps:
      - uses: Alfresco/alfresco-build-tools/.github/actions/pre-commit@v10.4.1
        with:
...
```yml
        ...
        uses: Alfresco/alfresco-build-tools/.github/actions/process-coverage-report@v10.4.1
        with:
          paths: |
...
```yml
      ...
      - uses: actions/setup-python@v4
        ...
        with:
          python-version: "3.9"
      - uses: Alfresco/alfresco-build-tools/.github/actions/pipenv@v10.4.1
        with:
...
```yaml
      - name: Register Cluster
        uses: Alfresco/alfresco-build-tools/.github/actions/rancher@v10.4.1
        with:
...
```yaml
      - name: Release Notes Aggregate
        uses: Alfresco/alfresco-build-tools/.github/actions/release-notes-aggregator@v10.4.1
        with:
...
[...]
    ...
    - name: Prepare Report Portal
      uses: Alfresco/alfresco-build-tools/.github/actions/reportportal-prepare@v10.4.1
      id: rp-prepare
      with:
    ...
    - name: Summarize Report Portal
      uses: Alfresco/alfresco-build-tools/.github/actions/reportportal-summarize@v10.4.1
      id: rp-summarize
      with:
...
```yaml
    ...
    - name: Notify Slack on failure
      if: always() && failure()
      uses: Alfresco/alfresco-build-tools/.github/actions/send-slack-notification@v10.4.1
      with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/resolve-preview-name@v10.4.1
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/send-slack-notification-slow-job@v10.4.1
        with:
          channel-id: 'channel-id'
          token: ${{ secrets.SLACK_BOT_TOKEN }}
...
```yml
      uses: Alfresco/alfresco-build-tools/.github/actions/send-teams-notification@v10.4.1
      with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/setup-checkov@v10.4.1
        with:
          version: '3.2.0'
```
...
```yaml
      - name: Setup Docker Engine
        uses: Alfresco/alfresco-build-tools/.github/actions/setup-docker@v10.4.1
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/setup-fluxcli@v10.4.1
        with:
          version: '2.6.4'
```
...
```yaml
    - uses: Alfresco/alfresco-build-tools/.github/actions/setup-github-release-binary@v10.4.1
      with:
        repo: org/repo-name
        version: '1.2.3'
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/setup-helm-docs@v10.4.1
        with:
          version: "1.14.2"
```
...
```yaml
      - name: Setup Java build
        uses: Alfresco/alfresco-build-tools/.github/actions/setup-java-build@v10.4.1
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/setup-jx-release-version@v10.4.1
        with:
          version: "2.2.3"
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/setup-kcadm@v10.4.1
        with:
          version: "24.0.5"
```
...
```yaml
      - name: Setup cluster
        uses: Alfresco/alfresco-build-tools/.github/actions/setup-kind@v10.4.1
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/setup-kubepug@v10.4.1
        with:
          version: "1.3.2"
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/setup-pysemver@v10.4.1
        with:
          version: "2.13.0"
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/setup-rancher-cli@v10.4.1
        with:
          version: "2.9.2"
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/setup-terraform-docs@v10.4.1
        with:
          version: "0.16.0"
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/setup-updatebot@v10.4.1
        with:
          version: "1.1.60"
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/setup-updatecli@v10.4.1
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/slack-file-upload@v10.4.1
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/sonar-scan-on-built-project@v10.4.1
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/sonar-scanner@v10.4.1
        with:
          sonar-token: ${{ secrets.SONAR_TOKEN }}
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/update-project-base-tag@v10.4.1
        with:
          release-descriptor: release.yaml
          project: activiti
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/validate-maven-versions@v10.4.1
        with:
          maven-username: ${{ secrets.NEXUS_USERNAME }}
          maven-password: ${{ secrets.NEXUS_PASSWORD }}
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/veracode@v10.4.1
...
jobs:
  promote:
    uses: Alfresco/alfresco-build-tools/.github/workflows/branch-promotion-prs.yml@v10.4.1
    with:
...
```yaml
  publish:
    uses: Alfresco/alfresco-build-tools/.github/workflows/helm-publish-new-package-version.yml@v10.4.1
    needs: build
    with:
      next-version: 7.4.0
      chart-dir: charts/common
...
jobs:
  check:
    uses: Alfresco/alfresco-build-tools/.github/workflows/pr-review-check.yml@v10.4.1
    with:
